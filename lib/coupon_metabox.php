...
function cp_meta_box_cb($post) {
    ...
    <p>
        ...
        <input type="text" name="discount_amount" id="discount_amount" value="<?php if (!empty($discount_amount)) echo formatocurrency($discount_amount,0,',','.'); ?>" placeholder="0.00" />
    ...
    <p>
        ...
        <input type="text" name="min_subtotal" id="min_subtotal" value="<?php if (!empty($min_subtotal)) echo formatocurrency($min_subtotal,0,',','.'); ?>" placeholder="<?php _e('No minimum','ocart'); ?>" />
