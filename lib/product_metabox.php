...
function pd_meta_box_cb($post) {
	...
	<p>
		...
		<span class="subcost"><?php _e('Cost per','ocart'); ?><input type="text" id="add_cost_count" /><?php _e('item(s)','ocart'); ?><input type="text" id="add_cost_price" /><?php echo $ocart['currencycode']; ?><a href="" id="add_cost" class="button-secondary"><?php _e('Add / Update Cost','ocart'); ?></a></span>
	</p>
