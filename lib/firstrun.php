...
if ( $flag == false && is_admin()){
	...
	*************************************************/
	$payments = array('webpay','paypal','co','visa','electron','mastercard','maestro','cirrus','amex','discover','solo','switch','delta','directdebit','moneybookers','westernunion','google','ebay','sage');
	update_option('occommerce_payment_logos', $payments);
	
	/*************************************************
	install default currency codes
	*************************************************/
	$currencies = array('CLP','AUD','CAD','EUR','GBP','JPY','USD','NZD','CHF','HKD','SGD','SEK','DKK','PLN','NOK','HUF','CZK','ILS','MXN','BRL','MYR','PHP','TWD','THB','TRY');
	...
	*************************************************/
	$defaults = array(
		...
		'grid_attr' => array('product_category', 'color', 'size'), // default grid view attributes
		'scroll_attr' => '', // default scrollable attributes empty
		'browser_attr' => array('product_category', 'color', 'size'), // default browser attributes
		'related_tax' => 'product_category', // default relationship for similar products
		'default_nav_tax' => 'color', // default navigation filter
		...
		'html_footer' => sprintf(__('Copyright &copy;2012 <a href="%s">%s</a>. Todos los derechos reservados.','ocart'), home_url(), get_bloginfo('name')), // footer copyright/text
		'html_contact_googlemaps' => '<iframe width="614" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.cl/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=arica&amp;ie=UTF8&amp;hq=&amp;hnear=Arica,+Arica+Province,+Arica+and+Parinacota+Region&amp;t=k&amp;ll=-18.477574,-70.312843&amp;spn=0.024422,0.052614&amp;z=14&amp;iwloc=A&amp;output=embed"></iframe>', // default googlemap for contact page
		'html_contact_addr' => 'Arica <br />Regi&oacute;n de Arica y Parinacota<br/>Arica - Chile', // default contact addr.
		'contact_phone' => '+56-9-68463262', // default contact phone
		'contact_fax' => '', // default contact fax
		'contact_email' => 'contacto@rincondeantonia.cl', // default contact email
		'contact_web' => 'www.rincondeantonia.cl', // default contact website
		...
		'catalog_version' => 1, // default to slider catalog
		'weight_unit' => 'lbs', // default weight unit
		'cost_per_item' => '', // default to none
		'ocml' => 0, // enable multi language module
		'ocmc' => 0, // enable multi currency module
		...
		'multi_currency' => 'CLP, USD, EUR, GBP, AUD, JPY', // default multi currency supported
...
$OCgateways = array(
		...
		'bank' => array ( 'name' => __('Transferencia Bancaria','ocart'), 'paymentname' => __('Transferencia Bancaria','ocart'), 'options' => array( 'enabled', 'instructions', 'charge' ) ),
