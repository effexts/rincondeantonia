...
function ocart_admin_css_and_js() {
	...
	wp_enqueue_script('oc_cookies_js_admin', MY_THEME_PATH . '/js/jquery.cookies.js');
	wp_enqueue_script('oc_colorpicker_js_admin', MY_THEME_PATH . '/js/colorpicker.js');
	wp_enqueue_script('oc_eye_js_admin', MY_THEME_PATH . '/js/eye.js');
    wp_enqueue_script('oc_utils_js_admin', MY_THEME_PATH . '/js/utils.js');
    wp_enqueue_script('oc_layout_js_admin', MY_THEME_PATH . '/js/layout.js');
	wp_enqueue_script('oc_editcountries', MY_THEME_PATH . '/js/countries.js');
	wp_enqueue_script('googlechart', 'https://www.google.com/jsapi');
	wp_register_script( 'product_datepicker', MY_THEME_PATH . '/js/datepickers.js',array('jquery','jquery-ui-datepicker'));
	...
	wp_enqueue_script('product_datepicker');
	
    
	wp_enqueue_script('oc_panel_js_admin', MY_THEME_PATH . '/js/panel.js');
		/* google fonts */
			wp_register_style('ocart_google_fonts','http://fonts.googleapis.com/css?family=Open+Sans|Bree+Serif|Ubuntu:300,400,500,700');
			wp_enqueue_style('ocart_google_fonts');
...
function ocart_enqueue_scripts() {
	wp_register_script('jqueryall', get_template_directory_uri() . '/js/jquery.js' );
	wp_register_script('ui', get_template_directory_uri() . '/js/jquery.ui.js' );
	wp_register_script('waypoints', get_template_directory_uri() . '/js/jquery.waypoints.js' );
	wp_register_script('iosslider', get_template_directory_uri() . '/js/jquery.iosslider.js' );
	wp_register_script('easing', get_template_directory_uri() . '/js/jquery.easing.js' );
	wp_register_script('tipsy', get_template_directory_uri() . '/js/jquery.tipsy.js' );
	wp_register_script('functions', get_template_directory_uri() . '/js/jquery.functions.js' );
	wp_register_script('bgpos', get_template_directory_uri() . '/js/jquery.bgpos.js' );
	wp_register_script('scrollto', get_template_directory_uri() . '/js/jquery.scrollTo.js' );
	wp_register_script('zoom', get_template_directory_uri() . '/js/jquery.jqzoom.js' );
	wp_register_script('lightbox', get_template_directory_uri() . '/js/jquery.lightbox.js' );
	wp_register_script('carousel', get_template_directory_uri() . '/js/jquery.carouFredSel.js' );
	wp_register_script('scrollbar', get_template_directory_uri() . '/js/jquery.mCustomScrollbar.js' );
	wp_register_script('mousewheel', get_template_directory_uri() . '/js/jquery.mousewheel.js' );
	wp_register_script('twitter', get_template_directory_uri() . '/js/jquery.twitter.js' );
	wp_register_script('jcookies', get_template_directory_uri() . '/js/jquery.cookies.js' );
	wp_enqueue_script('jqueryall');
...
?>
	...
	<link href='http://fonts.googleapis.com/css?family=Open+Sans|Montserrat|Bree+Serif|Ubuntu:300,400,500,700' rel='stylesheet' type='text/css'>
...
function ocart_product_icons() {
	...
	#menu-posts-product .wp-menu-image {
		background: url(<?php echo get_template_directory_uri() ?>/lib/img/product-16.png) no-repeat 8px center !important;
	}
    #menu-posts-product:hover .wp-menu-image, #menu-posts-product.wp-has-current-submenu .wp-menu-image {
		background: url(<?php echo get_template_directory_uri() ?>/lib/img/product-16-active.png) no-repeat 8px center !important;
	}
	...
	#menu-posts-slide .wp-menu-image {
		background: url(<?php echo get_template_directory_uri() ?>/lib/img/slide-16.png) no-repeat 8px center !important;
	}
    #menu-posts-slide:hover .wp-menu-image, #menu-posts-slide.wp-has-current-submenu .wp-menu-image {
		background: url(<?php echo get_template_directory_uri() ?>/lib/img/slide-16-active.png) no-repeat 8px center !important;
	}
