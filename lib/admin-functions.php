...
function ocart_get_new_orders() {
	...
	$count = count($posts);
	return '<a href="edit.php?post_status=received&post_type=orders" class="nostyle"><span class="ordercount_new">'.sprintf(__('<ins>%s</ins> New','ocart'), formatocurrency($count,0,',','.') ).'</span></a>';
}
...
function ocart_get_awaiting_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=awaiting&post_type=orders" class="nostyle"><span class="ordercount_awaiting">'.sprintf(__('<ins>%s</ins> Awaiting Payment','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_pending_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=pending&post_type=orders" class="nostyle"><span class="ordercount_pending">'.sprintf(__('<ins>%s</ins> Pending','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_processing_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=processing&post_type=orders" class="nostyle"><span class="ordercount_processing">'.sprintf(__('<ins>%s</ins> Processing','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_shipped_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=shipped&post_type=orders" class="nostyle"><span class="ordercount_shipped">'.sprintf(__('<ins>%s</ins> Shipped','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_delivered_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=delivered&post_type=orders" class="nostyle"><span class="ordercount_delivered">'.sprintf(__('<ins>%s</ins> Delivered','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_cancelled_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=cancelled&post_type=orders" class="nostyle"><span class="ordercount_cancelled">'.sprintf(__('<ins>%s</ins> Cancelled','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_declined_orders() {
	...
	$posts = get_posts( $args );
	$count = count($posts);
	return '<a href="edit.php?post_status=declined&post_type=orders" class="nostyle"><span class="ordercount_declined">'.sprintf(__('<ins>%s</ins> Declined','ocart'), formatocurrency($count,0,',','.')).'</span></a>';
}
...
function ocart_get_orders() {
	...
	return formatocurrency(count($orders),0,',','.');
}
